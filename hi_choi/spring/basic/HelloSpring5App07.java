...
public class HelloSpring5App07 {
    ...
    // 1. DI할(빌려올) bean 객체를 Ioc컨테이너에 등록
    //                      => xml bean 정의
    // 2. 등록된 bean 객체를 필요한 곳에 DI(빌려줌)
    //                      => autowiring
    ...
    // @Controller : 주로 MVC 객체에 사용 (빈정의시 사용)

	public static void main(String[] args) {
		ApplicationContext ctx = new FileSystemXmlApplicationContext("src/bean07.xml");
		
		
		// @Component 어노테이션 사용 예시 - bean07.xml과 hi_choi.spring.annotation 패키지 클래스 참조
